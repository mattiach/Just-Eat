const ApplicationForm = ({
  ...
  return (
    <>
      <div
        className={`mx-auto rounded-md bg-white border-4 ${isDragging ? 'border-blue-600' : 'border-transparent'}`}
      ...
      >
        ...
        <div className="space-y-4 px:4 pt-5 pb-2 md:px-8 md:pt-10 md:pb-4">
          ...
          <div>
            <button
              className={`mt-5 rounded-full bg-blue-600 px-10 py-2 font-semibold text-white ${selectedFiles.length < 1 ? 'opacity-50' : 'opacity-100'}`}
